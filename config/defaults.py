...
# Re-ranking hyper-parameters
_C.TEST.RE_RANK_K1 = 20
_C.TEST.RE_RANK_K2 = 6
_C.TEST.RE_RANK_LAMBDA = 0.3

# Path to trained model
_C.TEST.WEIGHT = ""

# Which feature of BNNeck to be used for test, before or after BNNeck
